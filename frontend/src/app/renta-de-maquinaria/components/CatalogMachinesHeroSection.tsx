...
interface Props {
	data: CatalogMachinesPageModel;
}

const CatalogMachinesHeroSection = ({ data }: Props) => {
		...
		>
			<div className="column__2">
				...
				<div className="col__right">
					...
					preload="none"
					>
						<source src="/videos/machines_ilco.mp4" type="video/mp4" />
...
export default CatalogMachinesHeroSection;
